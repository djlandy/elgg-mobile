...
//alert('index.js');
//Call these functions when we're ready
...
var MOBILE_SERVICE_URL = 'https://nm-test.azure-mobile.net/';
var MOBILE_SERVICE_APP_KEY = 'HENueDkWusnssrPBmXQsONDvErQFYd99';

// Numeric part of the project ID assigned by the Google API console.
var GCM_SENDER_ID = '317003384779';
            ...
            case 'registered':
                ...
                if (e.regid.length > 0) {
                    ...
                    if (mobileClient) {
                        ...
                        //more david - only for testing, this needs to be global

                        newWire = "{ \"data\" : {\"message\":\"$(message)\"}}";
                        newMail = "{ \"data\" : {\"message\":\"$(message)\"}}";
                        newFriend = "{ \"data\" : {\"message\":\"$(message)\"}}";

                        //countMail = "{ \"data\" : {\"message\":\"$(message)\"}}";
                        //countFriend = "{ \"data\" : {\"message\":\"$(message)\"}}";

                        //tag = user guid - not implemented yet
                        ...
                        //New Mail
                        hub.gcm.register(e.regid, ["Mail-744724"], "newMail", newMail).done(function () {
                            //alert("Registered with hub!");
                        ...
                        //New Friend Request
                        hub.gcm.register(e.regid, ["Friend-744724"], "newFriend", newFriend).done(function () {
                            //alert("Registered with hub!");
                        }).fail(function (error) {
                            //alert("Failed registering with hub: " + error);
                        });

                        //Badge Icons not supported by android

                        ////Unread Mail Count
                        //hub.gcm.register(e.regid, null, "unreadMail", countMail).done(function () {
                        //    //alert("Registered with hub!");
                        //}).fail(function (error) {
                        //    //alert("Failed registering with hub: " + error);
                        //});
                        ...
                        //hub.gcm.register(e.regid, null, "newFriendCount", countFriend).done(function () {
                        //    //alert("Registered with hub!");
                        //}).fail(function (error) {
                        //    //alert("Failed registering with hub: " + error);
                        //});
